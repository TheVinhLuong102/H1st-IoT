...
if __name__ == "__main__":
    train_param = {
        ...
        "summary_step":512,
        "printing_step":512,
        "save_model_path":"/tf/tim/cn_ccpm/vae/tf2/chkpoints/new_tfrecords/"

    }
    tfr_info = {
        "tfr_file_prefix": "part", 
        "rows": None, 
        "tfr_path": "/tf/tim/cn_ccpm/data/group_1",
        "columns": 7,
        "interval":1,
        "column_names": {"id_key": "store_name", "datetime_key": "date_time", "feature_key": "scaledFeatures", "label_key": "label"}
    }
